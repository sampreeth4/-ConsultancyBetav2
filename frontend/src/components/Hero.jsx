      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-evenly h-full bg-white z-10 sm:px-28">
        ...
        >
          ...
          <div className="flex justify-start space-x-4">
            <button className="bg-orange-500 text-white rounded-full px-8 py-3 hover:bg-orange-600 transition duration-300">
              Get Started
            </button>
            <button className="bg-transparent border-2 border-black text-black rounded-full px-8 py-3 hover:bg-orange-600 hover:text-white hover:border-none transition duration-300">
              Learn More
            </button>
          </div>
        </motion.div>
